...
- Highly compatible with MySQL: it supports almost all features of MySQL. For the complete details, see [parser.y](https://github.com/892294101/blob/master/parser/parser.y) and [hintparser.y](https://github.com/892294101/blob/master/parser/hintparser.y).
...
Please read the [quickstart](https://github.com/892294101/blob/master/parser/docs/quickstart.md).
...
- [GitHub Issue](https://github.com/892294101/issues)
...
- [892294101](https://github.com/892294101)
